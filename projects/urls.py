...
from .views import project_list, project_details, project_create,page_404,delete_project,update_project
...
urlpatterns = [
    ...
    path('update_project/<id>/',update_project.update_project,name = 'update_project'),
]